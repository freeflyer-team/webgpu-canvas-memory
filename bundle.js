var helloTriangle = async (canvas) => {
    const glslang = await Promise.resolve().then(function () { return glslang$1; }).then((mod) => {
        return mod.default();
    });
...
var glslang$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': glslang
});
